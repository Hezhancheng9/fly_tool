...
uint8_t InitMPU6050(void)
{
	...
	switch(Single_ReadI2C(WHO_AM_I)){
		case 0x68:
			PrintString("\r\n MPU6050  正常！");
			...
			I2C_delay(20000);            
			Single_WriteI2C(CONFIG2, 0x03);   	//低通滤波频率，典型值：0x00，不启用MPU6050自带滤波
			I2C_delay(20000);
		...
		case 0x98:
			...
			I2C_delay(2000000);
			Single_WriteI2C(SMPLRT_DIV, 0x00);  
			Single_WriteI2C(PWR_MGMT_1, 0x03);   
			I2C_delay(200000);
			Single_WriteI2C(CONFIG2, 0x03);     
			Single_WriteI2C(GYRO_CONFIG, 0x18);  
			Single_WriteI2C(ACCEL_CONFIG, 0x1F);
			Single_WriteI2C(0x1D, 0x04);
			// Data ready interrupt configuration
			Single_WriteI2C(INT_PIN_CFG, 0 << 7 | 0 << 6 | 0 << 5 | 1 << 4 | 0 << 3 | 0 << 2 | 1 << 1 | 0 << 0);   
			Single_WriteI2C(INT_ENABLE, 0x01);   		
			PrintString("\r\n MPU6050A  初始化完成！");
			break;
		default: 
			return 0;
